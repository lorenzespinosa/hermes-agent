...
_EXCLUDED_DIRS = {
    ...
    "browser-profile",
    # Native macOS real-profile supervisor state. This contains the dedicated
    # credential snapshot plus live runtime/lock identity and must never enter
    # a portable or pre-update archive.
    "browser-supervisor",
